    ...
    <div class="col bg-color-primary">
        <div class="hero-content d-flex flex-column align-content-center align-items-center">
            ...
            <div class="button-container text-left">
                <a class="button button-color-cta font-accent text-uppercase" href="<?php bloginfo('url'); ?>/get-started">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs col-md-4 col-lg-5 d-flex flex-column justify-content-center">
            ...
            <div class="button-container text-left">
                <a href="/get-started" class="btn">
                    <button class="button button-color-accent font-primary text-uppercase">
                        Learn More
                    </button>
                </a>
            </div>
