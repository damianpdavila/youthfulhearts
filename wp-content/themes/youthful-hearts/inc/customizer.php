...
function wp_bootstrap_starter_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'typography',
        array(
            'title' => __( 'Preset Styles', 'youthful-hearts' ),
            //'description' => __( 'This is a section for the typography', 'youthful-hearts' ),
            'priority' => 20,
        )
    );
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'theme_option_setting', array(
        'label' => __( 'Theme Option', 'youthful-hearts' ),
        'section'    => 'typography',
        'settings'   => 'theme_option_setting',
        'type'    => 'select',
        'choices' => array(
            'default' => 'Default',
            'youthfulheart' => 'Youthful Hearts',
            'cerulean' => 'Cerulean',
            'cosmo' => 'Cosmo',
            'cyborg' => 'Cyborg',
            'darkly' => 'Darkly',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'preset_style_setting', array(
        'label' => __( 'Typography', 'youthful-hearts' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_section(
        'header_image',
        array(
            'title' => __( 'Header Banner', 'youthful-hearts' ),
            'priority' => 30,
        )
    );
    ...
    $wp_customize->add_control(
        'header_img',
        array(
            'label' => __( 'Header Image', 'youthful-hearts' ),
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_bg_color',
            array(
                'label'      => __( 'Header Banner Background Color', 'youthful-hearts' ),
    ...
    $wp_customize->add_setting( 'header_banner_tagline_setting', array(
        'default' => __( 'To customize the contents of this header banner and other elements of your site go to Dashboard - Appearance - Customize','youthful-hearts' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_tagline_setting', array(
        'label' => __( 'Banner Tagline', 'youthful-hearts' ),
        'section'    => 'header_image',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_visibility', array(
        ...
        'label'    => __('Remove Header Banner', 'youthful-hearts'),
        'section'    => 'header_image',
        'type'     => 'checkbox',
    ) ) );
   ...
   $wp_customize->add_section(
        ...
        array(
            'title' => __( 'Other Customizations', 'youthful-hearts' ),
            //'description' => __( 'This is a section for the header banner Image.', 'youthful-hearts' ),
            'priority' => 40,
        )
    );
    $wp_customize->add_section(
        'colors',
        array(
            'title' => __( 'Background Color', 'youthful-hearts' ),
            //'description' => __( 'This is a section for the header banner Image.', 'youthful-hearts' ),
            'priority' => 50,
    ...
    $wp_customize->add_section(
        'background_image',
        array(
            'title' => __( 'Background Image', 'youthful-hearts' ),
            //'description' => __( 'This is a section for the header banner Image.', 'youthful-hearts' ),
            'priority' => 60,
            'panel' => 'styling_option_panel',
        )
    ...
    $wp_customize->add_setting( 'cdn_assets_setting', array(
        'default' => __( 'no','youthful-hearts' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( 
        'cdn_assets',
        array(
            'label' => __( 'Use CDN for Assets', 'youthful-hearts' ),
            'description' => __( 'All Bootstrap Assets and FontAwesome will be loaded in CDN.', 'youthful-hearts' ),
            'section' => 'site_name_text_color',
            'settings' => 'cdn_assets_setting',
	        'type'    => 'select',
	        'choices' => array(
	            'yes' => __( 'Yes', 'youthful-hearts' ),
	            'no' => __( 'No', 'youthful-hearts' ),
        	)
        )
    );

    // Phone and other site data
    $wp_customize->add_setting( 'contact_phone_setting', array(
        'default' => __( '','youthful-hearts' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'contact_phone_setting', array(
        'label' => __( 'Contact Phone', 'youthful-hearts' ),
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'wp_bootstrap_starter_logo', array(
        'label'    => __( 'Upload Logo (replaces text)', 'youthful-hearts' ),
        'section'  => 'title_tagline',
