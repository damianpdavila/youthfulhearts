        ...
        <div class="cta-form d-flex flex-column">
            ...
            <div class="row mb-4">
                ...
                <div class="form-container col col-lg-8">
                    ...
                    <img class="float-right mb-2" style="max-width: 150px;" src="<?php bloginfo('url'); ?>/wp-content/uploads/2022/08/secure-ssl-encryption-badge-transparent-300x103-edited.png" title="secure-ssl-encryption-badge" alt="secure-ssl-encryption-badge">
                </div>
                <!-- FORM END -->
            ...
            <div class="row mb-5">
                ...
                <p class="disclaimer text-white">By clicking the button and submitting this form, I agree that I am 18+ years old and I provide my signature expressly consenting to receive emails, calls, postal mail, text messages and other forms of communication regarding Medicare Supplements from <a href="#" data-toggle="modal" data-target="#companiesModal">companies</a> and agents to the number(s) I provided, including a mobile phone, even if I am on a state or federal Do Not Call and/or Do Not Email registry. The list of companies participating is subject to change. I will receive calls from a maximum of eight providers. Such calls and text messages may use automated telephone dialing systems, artificial or pre-recorded voices. I understand my wireless carrier may impose charges for calls or texts. I understand that my consent to receive communications is not a condition of purchase and I may revoke my consent at any time.</p>
            </div>
